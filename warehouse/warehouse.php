...
<body>
	...
	<div id="content">
		<div id="main-menu">
			...
			<ul>
				<li>Manage Orders</li>
				<a href="services/manageOrders.php" ><div> Orders </div></a>
				<li>Item Look-Up</li>
                                <a href="services/item_lookup.php" ><div> Item-Lookup </div></a>

                                <li>Modify Inventory</li>
                                <a href="services/modify_warehouses.php" ><div> Edit my Inventory</div></a>
